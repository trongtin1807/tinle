...
$kw = isset($_GET['DH51802544_kw'])?$_GET['DH51802544_kw']:'';
 ...
 <head>
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<?php include 'Sidebar.php' ?> <!-- End #main-nav -->
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<form>
				<input type="text" name="DH51802544_kw" value="<?php echo $kw ?>"><input type="submit" value="Search">
				</form>
				<table >
					<?php 
					foreach($data as $r)
					...
					<div class="tab-content" id="tab2">
							...
							ma sach: <input type="text" name="DH51802544_masach"> <br>
							ten sach: <input type="text" name="DH51802544_tensach"> <br>
							gia: <input type="number" name="DH51802544_gia"> <br>
							Hinh: <input type="file" name="DH51802544_hinh"> <br>
							Mo ta: <textarea name="DH51802544_mota" id="" cols="30" rows="3"></textarea> <br>
